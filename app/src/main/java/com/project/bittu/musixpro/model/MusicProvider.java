...
import static com.project.bittu.musixpro.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static com.project.bittu.musixpro.utils.MediaIDHelper.MEDIA_ID_ROOT;
import static com.project.bittu.musixpro.utils.MediaIDHelper.createMediaID;
...
public class MusicProvider {
    ...
    public MusicProvider(ContentResolver cr, Context context) {
        this(new LocalSource(cr, context));
    }
    ...
    private MediaBrowserCompat.MediaItem createBrowsableMediaItemForRoot(Resources resources) {
        MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
                ...
                .setIconUri(Uri.parse("android.resource://" +
                        "com.project.bittu.musixpro/drawable/ic_by_genre"))
                .build();
