...
public class TvBrowseActivity extends FragmentActivity
    ...
    public static final String SAVED_MEDIA_ID="com.project.bittu.musixpro.MEDIA_ID";
    public static final String BROWSE_TITLE = "com.project.bittu.musixpro.BROWSE_TITLE";
